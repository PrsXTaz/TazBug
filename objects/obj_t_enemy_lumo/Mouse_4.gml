...
if global.weapon = true
{
	if global.attack = false
	{
		if distance_to_object(obj_t_player_ladenstien_4testing) < global.range
		{
			...
			hp -= global.damage
			global.attack = true
			with(obj_t_player_ladenstien_4testing) alarm_set(0,global.recover_time)
		}
	}
}